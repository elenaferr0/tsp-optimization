...
typedef function<bool(const pair<int, double>&, const pair<int, double>&)> pair_comp;
typedef priority_queue<pair<int, double>, vector<pair<int, double> >, pair_comp> priority_queue_by_fitness;
...
static auto by_fitness_asc = [](const pair<int, double> &a, const pair<int, double> &b) {
